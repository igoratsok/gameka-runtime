...
public:
         ...
         * @param rectangle O outro retângulo.
         */
        bool intersectsXAxisWith(Rectangle *rectangle);
        /**
         * @brief Teste de intersecção com outro retângulo no eixo y apenas.
         *
         * @param rectangle O outro retângulo.
         */
        bool intersectsYAxisWith(Rectangle *rectangle);
        /**
         ...
         */
        static bool intersectMovingRectRect(Rectangle a, Rectangle b, Vector2 va, Vector2 vb,
         ...
         * @param tlast Momento de fim de colisão, entre 0 e 1 no quadro.
         */
        static bool sweepTestRectRect(Rectangle a, Rectangle b, Vector2 va, Vector2 vb, float *tfirst, float *tlast);
         ...
         */
        bool movingIntersectRect(Vector2 v, Rectangle rect, float *tfirst, float *tlast, int *lado, Rectangle *movedRectCol);
