...
void ScreenEffects::render(Screen *screen) {
	if(timerPisca > 0) {
		Sprite::drawRectNoScrolling(Rectangle(0, 0, 640, 480), corPiscaR, corPiscaG, corPiscaB, timerPisca, screen);
	...
	if(timerFadeIn > 0) {
		...
		Sprite::drawRectNoScrolling(Rectangle(0, 0, 640, 480), corFadeInR, corFadeInG, corFadeInB, alpha, screen);
	}
}
