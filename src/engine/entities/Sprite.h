...
public:
         ...
         *
         */
        Rectangle* getRectExact();
        /**
         * @brief Obtém o retângulo sem considerar rotação.
         *
         */
        Rectangle* getRectWithoutRot();
         ...
         * @param screen Tela do jogo.
         */
        static void drawRectNoScrolling(Rectangle rect, int r, int g, int b, int a, Screen *screen);
         ...
         * @param screen Tela do jogo.
         */
        static int drawRoundRectNoScrolling(Rectangle rect, int r, int g, int b, int a, int rad, Screen *screen);
        /**
        ...
        boost::multi_array<AnimationData, 2> animationDatas; /**< Dados de animação. */
